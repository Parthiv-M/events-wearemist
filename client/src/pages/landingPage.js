                    ...
                    <div style={{ minHeight: "75vh" }}>
                        <div className="container mx-auto text-center text-white">
                            ...
                            <Link to="/events/upcoming/0">
                                <button className="text-white font-weight-bold px-4 py-3 my-3 bg-transparent" style={{ border: "1px solid #6EE6B6", borderRadius: "40px" }}>
                                    VIEW MORE
                                </button>
                            </Link>
                        </div>
                    ...
                    <div style={{ minHeight: "100vh" }} className="my-4">
                        <div className="container mx-auto text-center text-white">
                            ...
                            <Link to="/events/past/0">
                                <button className="text-white font-weight-bold px-4 py-3 my-3 mb-5 bg-transparent" style={{ border: "1px solid #6EE6B6", borderRadius: "40px" }}>
                                    VIEW MORE
                                </button>
                            </Link>
                        </div>
